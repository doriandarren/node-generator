...
const createListPage = async (fullPath) => {
...
const createCreatePage = async (fullPath) => {
  const pagesDir = path.join(fullPath, 'src', 'modules', 'teams', 'pages');
...
const createEditPage = async (fullPath) => {
  // Definir la ruta del archivo
  const pagesDir = path.join(fullPath, 'src', 'modules', 'teams', 'pages');
  const filePath = path.join(pagesDir, 'TeamEditPage.jsx');
...
const createBarrelFile = async (fullPath) => {
  const pagesDir = path.join(fullPath, 'src', 'modules', 'teams', 'pages');
...
const createServiceFile = async (fullPath) => {
