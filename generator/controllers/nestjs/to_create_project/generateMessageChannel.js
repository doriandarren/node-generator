...
import { addHeaderLine, addModuleExport, addModuleProvider } from "../helpers/helperFileWrite.js";
...
export class MessageChannelService {
   ...
   */
  async send(text: string, title = 'Title', isError: false): Promise<void> {
    const url = this.configService.get<string>('MESSAGE_CHENNEL');
